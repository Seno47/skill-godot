...
| Exporter-owned building source roles / mesh or UV bindings | | | | NOT TESTED |
...
| Resolved marking mesh chains / mesh surfaces | | | | NOT TESTED |
...
## Visible facade/roof/openings/trim completeness
...
- Exporter-owned scene metadata and adapter inventory agree exactly on facade, roof and every present opening/window/trim role:
- Every role is tied to a real mesh instance/surface index or resolved shader-mask subregion:
- Shader subregions for openings/trim bind to exact source texture, UV channel and authored mask:
...
- Facade-mounted/suspended structures name resolved mount meshes and preserve support-vertex/mount-triangle point pairs whose recomputed 3D gaps pass:
...
- Adapter synthesizes facade/roof/openings/trim IDs or percentages from fewer real mesh/source-atlas roles: PASS / FAIL / NOT TESTED
