...
- Complete game/slice packet: fill the art-direction selection, semantic identity, menu craft, production-art state, HUD glanceability, character-motion and independent UX templates named above, with their required raw target-build states and reviewer owners; one self-review cannot replace the packet
