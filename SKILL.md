...
- For fixed/high-angle 3D districts, arenas, settlements, or extraction routes, pass a builder-owned visible-boundary, district-hierarchy, functional-zone, modular-variation, semantic architectural palette/material, view-corridor, negative-space, and camera-motion contract. Assign facade families by zone, function, construction, age, story state and adjacency; prove dominant/support/accent hierarchy, texture/material-slot preservation, and same-zone/cross-zone coherence under exact gameplay lighting. A perimeter fence, scattered containers, duplicated backdrop buildings, random per-instance flood fills, 100% material coverage, hue counts, valid navmesh, or an attractive still cannot certify an authored place.
...
- Complete fixed/high-angle 3D district or arena: add rubric modifier `high-angle-3d-district-complete`, fill `assets/high-angle-3d-district-review.template.md`, and preserve raw target-build boundary, corridor, typical/dense/objective/repetition frames plus normal-speed follow/lead/zoom/volume/obstruction restoration video
