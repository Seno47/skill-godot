...
- For fixed/high-angle 3D districts, arenas, settlements, or extraction routes, pass a builder-owned visible-boundary, district-hierarchy, functional-zone, modular-variation, view-corridor, negative-space, and camera-motion contract. A perimeter fence, scattered containers, duplicated backdrop buildings, prop count, valid navmesh, or attractive still cannot certify an authored place.
