...
- For fixed/high-angle 3D districts, arenas, settlements, or extraction routes, pass builder-owned district-composition and environment-integrity contracts. In addition to visible boundaries, hierarchy, functional zones, modular/material direction and camera motion, resolve every final transform and prove full-footprint prop occupancy, semantic surface ownership, render-mesh ground coverage/seams independent of broad floor colliders, and vertical clearance. A legal origin, complete collision/navmesh coverage, perimeter fence, scatter, clone filler, random flood fill, 100% material coverage or attractive still cannot certify an authored place.
...
- Dense 3D prop intersections, full-footprint surface ownership, visible ground seams, overhead clearance, or collision-PASS/visual-FAIL problems: [references/3d-environment-integrity.md](references/3d-environment-integrity.md)
...
- Complete fixed/high-angle 3D district or arena: add rubric modifier `high-angle-3d-district-complete`; fill `assets/high-angle-3d-district-review.template.md` and `assets/environment-integrity-review.template.md`; run `scripts/environment_integrity_audit.py` from the resolved target-scene contract; preserve raw target-build boundary, corridor, typical/dense/objective/repetition/integrity close-ups plus normal-speed follow/lead/zoom/volume/obstruction restoration video
