...
- High-angle roads, lane/junction/sidewalk/crosswalk topology, building mass in corridors, incomplete facade/roof/trim slots, hydrant/signal/sign/pole placement, incident road closures, or reachable pockets behind visible boundary props: [references/road-and-streetscape-semantics.md](references/road-and-streetscape-semantics.md), plus the district and environment-integrity guides
