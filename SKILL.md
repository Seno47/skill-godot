---
name: skill-godot
description: Build, extend, optimize, and visually and sonically polish Godot 4 games from a user-defined brief using native scenes, resources, imported assets, focused scripts, editor tooling, profiling, and verified playable results. Use for 2D, 3D, 2.5D, isometric, orthographic, hybrid, single-player, multiplayer, extraction, persistent online/MMO slices, UI, gameplay, levels, asset pipelines, audio, performance, loading, memory, export size, and project architecture in Godot; do not use for projects targeting another engine.
---
