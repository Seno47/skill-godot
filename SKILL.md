...
- For material progression, upgrades, escalating challenge, rewards, resources, or meta-economy, declare project-specific balance budgets before bulk content; prove archetype/checkpoint coverage, viable choices, source/sink health, recovery, and model-to-build transaction parity. A deterministic model cannot self-certify pacing, grind, or fun.
