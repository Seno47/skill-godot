...
| 45 deterministic Python helpers | Project/asset audits, resolved dependency-closure provenance, local/whole-map environment and road/junction/facade/furniture/reachability checks, visual checks, genre-aware difficulty and system contracts, crash/commerce/cloud/safety/upgrade/fault/hardware/assistive probes, rubric composition, capture, budgets, scorecards, and build-size checks |
