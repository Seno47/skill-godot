...
| --- | --- |
| 62 focused production guides | Scene architecture, visual-style selection, 2D/3D/2.5D, UI, production-craft/product approval, saves, accessibility, AI, genre/network systems, difficulty/pacing, commerce/cloud/safety, resilience/upgrades, hardware, assets, performance, and release work |
| 40 deterministic Python helpers | Project/asset audits, visual checks, genre-aware difficulty and system contracts, crash/commerce/cloud/safety/upgrade/fault/hardware/assistive probes, rubric composition, capture, budgets, scorecards, and build-size checks |
