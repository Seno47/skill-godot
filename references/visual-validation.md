...
For a fixed/high-angle 3D district/arena case, use `assets/high-angle-3d-district-review.template.md` plus `assets/environment-integrity-review.template.md` as builder-owned precursors. They must fail routine boundary, massing, repetition, semantic-density, camera-motion, transformed-contact, surface-ownership, visible-ground and clearance defects before independent or owner review.
