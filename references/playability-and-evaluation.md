...
```bash
python <skill-dir>/scripts/evidence_helper.py --rubric <skill-dir>/evals/rubric.json --case <case-id> --output <evidence.json> --capture-manifest-output <captures.json> --project-status-output <project-run-state.md> --art-direction-selection-output <art-direction.md> --review-output <independent-review.md> --menu-review-output <menu-review.md> --cross-surface-craft-review-output <cross-surface-review.md> --review-profile-reset-output <review-profile.md> --product-owner-slice-output <owner-slice.md> --hud-review-output <hud-review.md> --production-art-review-output <production-art-review.md> --production-motion-review-output <production-motion.md> --motion-review-output <character-motion.md> --yandex-checklist-output <yandex-checklist.md>
